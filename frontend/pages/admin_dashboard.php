...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-5 mb-8">
  <a href="/cars/frontend/pages/admin_courses.php" class="card p-5 hover:border-brand-300 transition"><div class="font-semibold text-slate-900">Manage Courses</div><p class="text-sm text-slate-500 mt-1">Add, edit and remove courses.</p></a>
  <a href="/cars/frontend/pages/admin_records.php" class="card p-5 hover:border-brand-300 transition"><div class="font-semibold text-slate-900">Enter Grades</div><p class="text-sm text-slate-500 mt-1">Record student academic results.</p></a>
  <a href="/cars/frontend/pages/admin_users.php" class="card p-5 hover:border-brand-300 transition"><div class="font-semibold text-slate-900">Manage Users</div><p class="text-sm text-slate-500 mt-1">View users and create staff accounts.</p></a>
  <a href="/cars/frontend/pages/admin_reports.php" class="card p-5 hover:border-brand-300 transition"><div class="font-semibold text-slate-900">View Reports</div><p class="text-sm text-slate-500 mt-1">System statistics and analytics.</p></a>
</div>
